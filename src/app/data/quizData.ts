...
export const quizDataByCategory: Record<string, Question[]> = {
  "ça va où ?": [
    ...
    },
    {
      ...
      explanation: "Pour trouver la pharmacie la plus proche de chez vous pour déposer vos médicaments, rendez-vous sur la page \"Médicaments\" de [Que faire de mes déchets](https://quefairedemesdechets.ademe.fr/categories/medicaments/?utm_campaign=circularoulette_enligne)",
      source: "Médicaments"
    },
    {
      id: 13,
